...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span class="logo-lg">Educive</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="adminpanel/dist/img/admin.png" class="user-image" alt="User Image">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li>
          ...
          <ul class="treeview-menu">
            <li>
					<a href="/waitlist"><i class="fa fa-circle-o"></i>
						Not Approved
						<span class="label label-primary">{{ $notApproved }}</span>
					</a>
				</li>
            <li><a href="/approved"><i class="fa fa-circle-o"></i> Approved Posts</a></li>
          </ul>
        </li>
		  <li>
          <a href="/dashboard">
